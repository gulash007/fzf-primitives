...
@mods.on_event("ctrl-6").run("git add --patch", "execute(git add --patch -- {})", "refresh-preview")
...
@mods.on_event("ctrl-6").run("git reset --patch", "execute(git reset --patch -- {})", "refresh-preview")
